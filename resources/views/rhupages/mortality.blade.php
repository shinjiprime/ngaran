...
<div class="card">
    <div class="card-header">
        ...
        <div class="d-flex justify-content-between align-items-center p-3">
            <strong class="card-title fs-5"> {{ session('facility_name') }} Mortality</strong>
    ...
    <div class="card-body">
        <div class="table-responsive" id="patients-table-container">
            @include('rhupages.partials.records')
        </div>
    </div>
</div>
...
<script>
    ...
    const reportType = 'mortality'; // or "morbidity" as needed
...
<script>$(document).ready(function () {
    ...
    $('#year-select, #month-select, #quarter-select, #gender-select, #age-group-select').on('change', function () {
