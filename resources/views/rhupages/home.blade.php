                        ...
                        <div class="card-body">
                            <div class="row no-gutters align-items-center">
                                <div class="col mr-0">
                                    ...
                                    <hr class="my-2"> 
                                    <button class="btn btn-danger mt-3" onclick="window.location.href='{{ route('generate.disease.report2') }}'">
                                        Generate Report
                                    </button>
                                </div>
                            </div>
                        ...
                        <div class="card-body">
                            <div class="row no-gutters align-items-center">
                                <div class="col mr-0">
                                    ...
                                    <hr class="my-2"> 
                                    <button class="btn btn-warning mt-3" onclick="window.location.href='{{ route('generate.disease2.report2') }}'">
                                        Generate Report
                                    </button>
                                </div>
                        ...
                        <div class="card-body">
                            <div class="row no-gutters align-items-center">
                                <div class="col mr-0">
                                    ...
                                    <div class="h6 mb-0 font-weight-bold text-gray-800">
                                        <ul class="list-group list-group-flush">
                                            @foreach($topSickAreas as $healthFacility)
                                            <li class="list-group-item">
                                                {{ $healthFacility['facility_name'] }} - {{ $healthFacility['death_count'] }} cases
                                            </li>
                                            @endforeach
                                        </ul>
                                    </div>
                                    <hr class="my-2"> 
                                    <button class="btn btn-success mt-3" onclick="window.location.href='{{ route('generate.disease3.report2') }}'">
                                        Generate Report
                                    </button>
                                </div>
                          ...
                          <div class="row no-gutters align-items-center">
                              <div class="col mr-0">
                                  <div class="text-xs font-weight-bold text-success text-uppercase mb-1"><i class="fas fa-virus fa-2x text-gray-300"></i>Top 10 Highest Mortality Areas
                                      ...
                                      <div class="h6 mb-0 font-weight-bold text-gray-800">
                                        <ul class="list-group list-group-flush">
                                            @foreach($topDeadlyAreas as $healthFacility)
                                                <li class="list-group-item">
                                                    {{ $healthFacility['facility_name'] }} - {{ $healthFacility['death_count'] }} deaths
                                                </li>
                                            @endforeach
                                        </ul>
                                    ...
                                    <hr class="my-2"> 
                                    <button class="btn btn-success mt-3" onclick="window.location.href='{{ route('generate.disease4.report2') }}'">
                                        Generate Report
                                    </button>
