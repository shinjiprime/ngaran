        ...
        <div class="modal-content">
            ...
            <form action="{{ route('patients.update', ['id' => ':id']) }}" id="saveItem" method="POST">
                <div class="modal-body">
                    ...
                    <!-- Disease Code -->
                    <!-- Disease Code with Select2 Searchable Dropdown (Edit Modal) -->
            ...
            <table id='bootstrap-data-table-export' class='table table-striped table-bordered'>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <form action="{{ route('patient.deceased', $patient->patients_id) }}" method="POST">
                                @csrf
                                <button type="submit" class="btn btn-danger btn-sm">Mark as Deceased</button>
                            </form>
                        </td>
                    </tr>
                    @endforeach
...
<script>
    $(document).ready(function () {
        $(document).on('click', '.editWorkerBtn', function() {
            ...
            $('#disease_code').val(data[5]).trigger('change');
            $('#staff_id').val(data[6]);
            $('#date').val(data[7]);
            $('#age').val(data[8]);
            $('#age_unit').val(data[9]);
