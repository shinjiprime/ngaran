          ...
          <form action="{{ route('patients.create') }}" method="POST">
              <div class="modal-body">
                  ...
                  <div class="mb-3">
                      ...
                      <input type="text" name="disease_code" class="form-control" required />
                  </div>
            ...
            <form action="{{ route('patients.update', ['id' => ':id']) }}" id="saveItem" method="POST">
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="disease_code" id="disease_code" class="form-control" required />
                    </div>
